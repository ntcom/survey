...
!function(t, e) {
    ...
    void 0 !== t.nodeType)
      ...
      , C = (t,e,i,s)=>{
        let n = t.length
          , r = t.indexOf(e);
        return -1 === r ? !i && s ? t[n - 1] : t[0] : (r += i ? 1 : -1,
        s && (r = (r + n) % n),
    ...
    function H(t, e, i, s, n) {
        let r = O(e[i], s, n);
        r && (t.removeEventListener(i, r, Boolean(n)),
        delete e[i][r.uidEvent])
    }
    function W(t, e, i, s) {
        let n = e[i] || {};
        ...
        _typeCheckConfig(t, e=this.constructor.DefaultType) {
            for (let i of Object.keys(e)) {
                let n = e[i]
                  ...
                  , o = c(r) ? "element" : s(r);
                if (!RegExp(n).test(o))
                    throw TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${i}" provided type "${o}" but expected type "${n}".`)
            }
        }
    }
    let Q = "5.2.2";
    ...
    class tS extends X {
        ...
        _initEvents() {
            this._supportPointerEvents ? (q.on(this._element, ty, t=>this._start(t)),
            q.on(this._element, tw, t=>this._end(t)),
            this._element.classList.add(tC)) : (q.on(this._element, t8, t=>this._start(t)),
            q.on(this._element, tb, t=>this._move(t)),
            q.on(this._element, t$, t=>this._end(t)))
        }
    ...
    class ei extends Z {
        constructor(t, e) {
            ...
            this._indicatorsElement = tg.findOne(tQ, this._element),
        ...
        _addEventListeners() {
            this._config.keyboard && q.on(this._element, tR, t=>this._keydown(t)),
            "hover" === this._config.pause && (q.on(this._element, t9, ()=>this.pause()),
            q.on(this._element, tq, ()=>this._maybeEnableCycle())),
            this._config.touch && tS.isSupported() && this._addTouchEventListeners()
        }
        _addTouchEventListeners() {
            for (let t of tg.find(t4, this._element))
                q.on(t, t3, t=>t.preventDefault());
            let e = ()=>{
                "hover" === this._config.pause && (this.pause(),
                this.touchTimeout && clearTimeout(this.touchTimeout),
                this.touchTimeout = setTimeout(()=>this._maybeEnableCycle(), tM + this._config.interval))
            }
              , i = {
    ...
    class ex extends Z {
        ...
        show() {
            ...
            let n = ()=>{
                ...
                this._element.classList.add(ep, ed),
                this._element.style[s] = "",
                q.trigger(this._element, el)
            }
        ...
        hide() {
            ...
            m(this._element),
            this._element.classList.add(ef),
            this._element.classList.remove(ep, ed),
            this._triggerArray)) {
                let s = a(i);
    ...
    function eK(t) {
        ...
        Object.keys(e.elements).forEach(function(t) {
            var i = e.styles[t] || {}
              , s = e.attributes[t] || {}
              , n = e.elements[t];
            eV(n) && eB(n) && (Object.assign(n.style, i),
    ...
    function eU(t) {
        ...
        function() {
            Object.keys(e.elements).forEach(function(t) {
                ...
                eV(s) && eB(s) && (Object.assign(s.style, r),
    ...
    function eJ(t, e, i) {
        ...
        var s = t.getBoundingClientRect()
          , n = 1
          , r = 1;
        e && eV(t) && (n = t.offsetWidth > 0 && eQ(s.width) / t.offsetWidth || 1,
        r = t.offsetHeight > 0 && eQ(s.height) / t.offsetHeight || 1);
    ...
    function il(t) {
        ...
        if (/Trident/i.test(eZ()) && eV(t) && "fixed" === ii(t).position)
            return null;
        var i = io(t);
    ...
    function ih(t) {
        for (var e = e1(t), i = ia(t); i && is(i) && "static" === ii(i).position; )
            i = ia(i);
    ...
    function i8(t) {
        var e, i = t.state, s = t.name, n = t.options, r = i.elements.arrow, o = i.modifiersData.popperOffsets, a = e2(i.placement), l = ic(a), h = [eA, eD].indexOf(a) >= 0 ? "height" : "width";
        if (r && o) {
    ...
    function ix(t) {
        var e, i, s = t.popper, n = t.popperRect, r = t.placement, o = t.variation, a = t.offsets, l = t.position, h = t.gpuAcceleration, c = t.adaptive, u = t.roundOffsets, d = t.isFixed, p = a.x, f = void 0 === p ? 0 : p, g = a.y, m = void 0 === g ? 0 : g, v = "function" == typeof u ? u({
            x: f,
            y: m
        }) : {
            x: f,
        ...
        if (c) {
            var x = ih(s)
              ...
              , k = "clientWidth";
            x === e1(s) && (x = ir(s),
            "static" !== ii(x).position && "absolute" === l && (C = "scrollHeight",
            k = "scrollWidth")),
            (r === eC || (r === eA || r === eD) && o === eT) && (w = ek,
            m -= (d && x === _ && _.visualViewport ? _.visualViewport.height : x[C]) - n.height,
            m *= h ? 1 : -1),
            (r === eA || (r === eC || r === ek) && o === eT) && (y = eD,
            f -= (d && x === _ && _.visualViewport ? _.visualViewport.width : x[k]) - n.width,
            f *= h ? 1 : -1)
        }
        var D = Object.assign({
            position: l
        ...
        return (f = A.x,
        m = A.y,
        h) ? Object.assign({}, D, ((i = {})[w] = $ ? "0" : "",
        i[y] = b ? "0" : "",
        i.transform = 1 >= (_.devicePixelRatio || 1) ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)",
        i)) : Object.assign({}, D, ((e = {})[w] = $ ? m + "px" : "",
        e[y] = b ? f + "px" : "",
        e.transform = "",
        e))
    }
    ...
    function iO(t) {
        var e, i = ir(t), s = iF(t), n = null == (e = t.ownerDocument) ? void 0 : e.body, r = eX(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0), o = eX(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0), a = -s.scrollLeft + iz(t), l = -s.scrollTop;
    ...
    function iN(t, e) {
        void 0 === e && (e = []);
        var i, s = i0(t), n = s === (null == (i = t.ownerDocument) ? void 0 : i.body), r = e1(s), o = n ? [r].concat(r.visualViewport || [], iL(s) ? s : []) : s, a = e.concat(o);
    ...
    function iq(t, e, i, s) {
        var n = [].concat("clippingParents" === e ? i9(t) : [].concat(e), [i])
          ...
          , o = n.reduce(function(e, i) {
            var n = iR(t, i, s);
            return e.top = eX(n.top, e.top),
            e.right = e4(n.right, e.right),
            e.bottom = e4(n.bottom, e.bottom),
            e.left = eX(n.left, e.left),
            e
        }, iR(t, r, s));
    ...
    function i3(t) {
        var e, i = t.reference, s = t.element, n = t.placement, r = n ? e2(n) : null, o = n ? iy(n) : null, a = i.x + i.width / 2 - s.width / 2, l = i.y + i.height / 2 - s.height / 2;
        switch (r) {
        case eC:
            e = {
                x: a,
        ...
        if (!e.modifiersData[s]._skip) {
            ...
            if (C)
                for (var O = m ? 3 : 1, L = function t(e) {
                    ...
                    ;
            e.placement !== k && (e.modifiersData[s]._skip = !0,
            e.placement = k,
            e.reset = !0)
        }
    }
    ...
    function iG(t) {
        ...
        if (_) {
            if (r) {
                var P, I = "y" === y ? eC : eA, T = "y" === y ? ek : eD, E = "y" === y ? "height" : "width", F = _[y], z = F + m[I], M = F - m[T], O = p ? -C[E] / 2 : 0, L = b === eI ? x[E] : C[E], N = b === eI ? -C[E] : -x[E], H = e.elements.arrow, W = p && H ? it(H) : {
                    width: 0,
                    height: 0
                }, R = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ip(), q = R[I], j = R[T], Y = iu(0, x[E], W[E]), B = $ ? x[E] / 2 - O - Y - q - D.mainAxis : L - Y - q - D.mainAxis, V = $ ? -x[E] / 2 + O + Y + j + D.mainAxis : N + Y + j + D.mainAxis, K = e.elements.arrow && ih(e.elements.arrow), U = K ? "y" === y ? K.clientTop || 0 : K.clientLeft || 0 : 0, X = null != (P = null == A ? void 0 : A[y]) ? P : 0, Q = F + B - X - U, Z = F + V - X, G = iu(p ? e4(z, Q) : z, F, p ? eX(M, Z) : M);
                _[y] = G,
                S[y] = G - F
            }
            if (a) {
                var J, tt = "x" === y ? eC : eA, te = "x" === y ? ek : eD, ti = _[w], ts = "y" === w ? "height" : "width", tn = ti + m[tt], tr = ti - m[te], to = -1 !== [eC, eA].indexOf(v), ta = null != (J = null == A ? void 0 : A[w]) ? J : 0, tl = to ? tn : ti - x[ts] - C[ts] - ta + D.altAxis, th = to ? ti + x[ts] + C[ts] - ta - D.altAxis : tr, tc = p && to ? id(tl, ti, th) : iu(p ? tl : tn, ti, p ? th : tr);
                _[w] = tc,
                S[w] = tc - ti
            }
            e.modifiersData[s] = S
    ...
    function ss(t, e, i) {
        ...
        return (s || !s && !i) && (("body" !== eB(e) || iL(r)) && (a = se(e)),
        eV(e) ? (l = eJ(e, !0),
        l.x += e.clientLeft,
        l.y += e.clientTop) : r && (l.x = iz(r))),
        {
    ...
    class sU extends Z {
        constructor(t, e) {
            ...
            this._menu = tg.next(this._element, sH)[0] || tg.prev(this._element, sH)[0] || tg.findOne(sH, this._parent),
        ...
        show() {
            if (p(this._element) || this._isShown())
                return;
            let t = {
            ...
            if (!e.defaultPrevented) {
                ...
                "ontouchstart"in document.documentElement && !this._parent.closest(sR))
        ...
        _getPlacement() {
            ...
            if (t.classList.contains(sz))
                return sB;
            if (t.classList.contains(sM))
                return s1;
            if (t.classList.contains(sO))
                return s7;
            if (t.classList.contains(sL))
                return sV;
        ...
        static clearMenus(t) {
            if (t.button === sC || "keyup" === t.type && t.key !== sw)
                return;
            let e = tg.find(sN);
            for (let i of e) {
                ...
                if (n.includes(s._element) || "inside" === s._config.autoClose && !r || "outside" === s._config.autoClose && r || s._menu.contains(t.target) && ("keyup" === t.type && t.key === sw || /input|select|option|textarea|form/i.test(t.target.tagName)))
                    continue;
                let o = {
    ...
    q.on(document, sI, s0, sU.dataApiKeydownHandler),
    q.on(document, sI, sH, sU.dataApiKeydownHandler),
    q.on(document, sP, sU.clearMenus),
    q.on(document, sT, sU.clearMenus),
    q.on(document, sP, s0, function(t) {
        t.preventDefault(),
        sU.getOrCreateInstance(this).toggle()
    }),
    w(sU);
    ...
    class sQ {
        ...
        hide() {
            ...
            this._setElementAttributes(this._element, sX, e=>e + t),
            this._setElementAttributes(s6, sX, e=>e + t),
            this._setElementAttributes(s2, s4, e=>e - t)
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"),
            this._resetElementAttributes(this._element, sX),
            this._resetElementAttributes(s6, sX),
            this._resetElementAttributes(s2, s4)
        }
        isOverflowing() {
        ...
        _applyManipulationCallback(t, e) {
            ...
            for (let i of tg.find(t, this._element))
                e(i)
        }
    }
    let sZ = "backdrop"
    ...
    class ns extends X {
        ...
        dispose() {
            this._isAppended && (q.off(this._element, nt),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
            if (!this._element) {
                ...
                this._config.isAnimated && t.classList.add(sG),
                this._element = t
            }
            return this._element
        }
        _configAfterMerge(t) {
            return t.rootElement = u(t.rootElement),
            t
        }
        _append() {
            if (this._isAppended)
    ...
    class nf extends X {
        ...
        activate() {
            ...
            q.off(document, no),
            q.on(document, na, t=>this._handleFocusin(t)),
            q.on(document, nl, t=>this._handleKeydown(t)),
            this._isActive = !0)
        }
        deactivate() {
    ...
    class nN extends Z {
        constructor(t, e) {
            super(t, e),
            this._dialog = tg.findOne(nz, this._element),
            this._backdrop = this._initializeBackDrop(),
            this._focustrap = this._initializeFocusTrap(),
            this._isShown = !1,
            this._isTransitioning = !1,
            this._scrollBar = new sQ,
            this._addEventListeners()
        }
        static get Default() {
            return nL
        ...
        show(t) {
            ...
            document.body.classList.add(nP),
            this._adjustDialog(),
        ...
        _hideModal() {
            ...
            this._isTransitioning = !1,
            this._backdrop.hide(()=>{
                document.body.classList.remove(nP),
                this._resetAdjustments(),
                this._scrollBar.reset(),
                q.trigger(this._element, nw)
            }
            )
        }
        _isAnimated() {
    ...
    class nJ extends Z {
        ...
        show(t) {
            ...
            this._isShown = !0,
            this._backdrop.show(),
            this._config.scroll || new sQ().hide(),
            this._element.setAttribute("aria-modal", !0),
            this._element.setAttribute("role", "dialog"),
            this._element.classList.add(nY);
            let i = ()=>{
                (!this._config.scroll || this._config.backdrop) && this._focustrap.activate(),
                this._element.classList.add(nj),
                this._element.classList.remove(nY),
                q.trigger(this._element, n5, {
                    relatedTarget: t
                })
            }
            ;
        ...
        hide() {
            ...
            this._backdrop.hide();
            let e = ()=>{
                this._element.classList.remove(nj, nB),
                this._element.removeAttribute("aria-modal"),
                this._element.removeAttribute("role"),
                this._config.scroll || new sQ().reset(),
                q.trigger(this._element, n6)
            }
            ;
    ...
    q.on(window, nq, ()=>{
        for (let t of tg.find(n7))
            nJ.getOrCreateInstance(t).show()
    }
    ),
    q.on(window, n2, ()=>{
        for (let t of tg.find("[aria-modal][class*=show][class*=offcanvas-]"))
    ...
    function ro(t, e, i) {
        ...
        for (let o of r) {
            ...
            let l = [].concat(...o.attributes)
              , h = [].concat(e["*"] || [], e[a] || []);
            for (let c of l)
                rn(c, h) || o.removeAttribute(c.nodeName)
        }
    ...
    class rO extends Z {
        ...
        dispose() {
            ...
            q.off(this._element.closest(r8), rb, this._hideModalHandler),
        ...
        show() {
            ...
            q.trigger(this._element, this.constructor.eventName(rA))),
            ...
            "ontouchstart"in document.documentElement)
                for (let r of [].concat(...document.body.children))
                    q.on(r, "mouseover", g);
            let o = ()=>{
                q.trigger(this._element, this.constructor.eventName(rD)),
        ...
        hide() {
            ...
            if (e.classList.remove(rm),
            "ontouchstart"in document.documentElement)
                for (let i of [].concat(...document.body.children))
                    q.off(i, "mouseover", g);
            this._activeTrigger[rw] = !1,
            this._activeTrigger[ry] = !1,
            this._activeTrigger[r$] = !1,
            this._isHovered = null;
            let s = ()=>{
                !this._isWithActiveTrigger() && (this._isHovered || e.remove(),
                this._element.removeAttribute("aria-describedby"),
                q.trigger(this._element, this.constructor.eventName(rC)),
                this._disposePopper())
            }
            ;
        ...
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new ru({
                ...this._config,
                content: t,
        ...
        _setListeners() {
            ...
            for (let e of t)
                if ("click" === e)
                    q.on(this._element, this.constructor.eventName(rS), this._config.selector, t=>{
                    ...
                    q.on(this._element, i, this._config.selector, t=>{
                        let e = this._initializeOnDelegatedTarget(t);
                        e._activeTrigger["focusin" === t.type ? ry : r$] = !0,
                        e._enter()
                    }
                    ),
                    q.on(this._element, s, this._config.selector, t=>{
                        let e = this._initializeOnDelegatedTarget(t);
                        e._activeTrigger["focusout" === t.type ? ry : r$] = e._element.contains(t.relatedTarget),
                        e._leave()
                    }
                    )
                }
        ...
        _configAfterMerge(t) {
            return t.container = !1 === t.container ? document.body : u(t.container),
    ...
    class ot extends Z {
        ...
        _configAfterMerge(t) {
            return t.target = u(t.target) || document.body,
            t.rootMargin = t.offset ? `${t.offset}px 0px -30%` : t.rootMargin,
            "string" == typeof t.threshold && (t.threshold = t.threshold.split(",").map(t=>Number.parseFloat(t))),
            t
        }
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (q.off(this._config.target, rB),
            q.on(this._config.target, rB, rK, t=>{
        ...
        _observerCallback(t) {
            ...
            for (let r of (this._previousScrollData.parentScrollTop = s,
            t)) {
                if (!r.isIntersecting) {
                    this._activeTarget = null,
        ...
        _initializeTargetsAndObservables() {
            ...
            for (let e of t) {
                ...
                d(i) && (this._targetLinks.set(e.hash, e),
    ...
    class oA extends Z {
        constructor(t) {
            if (super(t),
            this._parent = this._element.closest(ow),
            !this._parent)
                return;
            this._setInitialAttributes(this._parent, this._getChildren()),
            q.on(this._element, oh, t=>this._keydown(t))
        }
        static get NAME() {
            return oe
        }
        ...
        _deactivate(t, e) {
            if (!t)
                return;
            t.classList.remove(og),
            t.blur(),
            this._deactivate(a(t));
            let i = ()=>{
                if ("tab" !== t.getAttribute("role")) {
    ...
    q.on(document, ol, oC, function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        !p(this) && oA.getOrCreateInstance(this).show()
    }),
    q.on(window, oc, ()=>{
        for (let t of tg.find(oD))
            oA.getOrCreateInstance(t)
    }
    ),
    w(oA);
    let oS = "toast"
    ...
    class o3 extends Z {
        ...
        show() {
            ...
            let e = ()=>{
                ...
                q.trigger(this._element, o0),
                this._maybeScheduleHide()
            }
            ;
            this._element.classList.remove(oH),
            m(this._element),
            this._element.classList.add(oW, oR),
        ...
        hide() {
            ...
            if (t.defaultPrevented)
                return;
            let e = ()=>{
                this._element.classList.add(oH),
                this._element.classList.remove(oR, oW),
                q.trigger(this._element, oO)
            }
            ;
        ...
        dispose() {
            this._clearTimeout(),
            this.isShown() && this._element.classList.remove(oW),
            super.dispose()
        }
        isShown() {
        ...
        _setListeners() {
            q.on(this._element, oT, t=>this._onInteraction(t, !0)),
            q.on(this._element, oE, t=>this._onInteraction(t, !1)),
            q.on(this._element, oF, t=>this._onInteraction(t, !0)),
            q.on(this._element, oz, t=>this._onInteraction(t, !1))
        }
        _clearTimeout() {
            clearTimeout(this._timeout),
            this._timeout = null
        ...
        zIndex: function(i) {
            ...
            if (this.length)
                for (var s, n, r = t(this[0]); r.length && r[0] !== document; ) {
                    if (("absolute" === (s = r.css("position")) || "relative" === s || "fixed" === s) && (n = parseInt(r.css("zIndex"), 10),
                    !isNaN(n) && 0 !== n))
                        return n;
                    r = r.parent()
                }
...
function(t, e) {
    ...
    t.widget = function(e, i, s) {
        ...
        ;
        var o = new i;
        o.options = t.extend(!0, {}, o.options),
        t[r][e].prototype = t.extend(!0, o, {
            namespace: r,
            widgetName: e,
    ...
    t.widget.bridge = function(i, s) {
        t.fn[i] = function(n) {
            var r = "string" == typeof n
              ...
              , a = this;
            return n = !r && o.length ? t.extend.apply(null, [!0, n].concat(o)) : n,
            r && "_" === n.charAt(0) || (r ? this.each(function() {
                var s = t.data(this, i)
    ...
    t.Widget.prototype = {
        ...
        _trigger: function(e, i, s) {
            ...
            !(t.isFunction(o) && !1 === o.call(this.element[0], i, s) || i.isDefaultPrevented())
        }
    }
}(jQuery),
function(t, e) {
    ...
    t.widget("ui.mouse", {
        ...
        _mouseDown: function(e) {
            if (!i) {
                ...
                return !(n && !r && this._mouseCapture(e)) || ((this.mouseDelayMet = !this.options.delay,
...
function(t, e) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        _generatePosition: function(e) {
            var i, s = this.options, n = "absolute" != this.cssPosition || this.scrollParent[0] != document && t.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, r = /(html|body)/i.test(n[0].tagName), o = e.pageX, a = e.pageY;
            if (this.originalPosition) {
                if (this.containment) {
                    if (this.relative_container) {
                        ...
                        i = this.containment;
                    e.pageX - this.offset.click.left < i[0] && (o = i[0] + this.offset.click.left),
                    e.pageY - this.offset.click.top < i[1] && (a = i[1] + this.offset.click.top),
                    e.pageX - this.offset.click.left > i[2] && (o = i[2] + this.offset.click.left),
                    e.pageY - this.offset.click.top > i[3] && (a = i[3] + this.offset.click.top)
                }
                if (s.grid) {
    ...
    t.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(e, i) {
            var s = t(this).data("draggable")
              , n = s.options
              , r = !1;
            s.scrollParent[0] != document && "HTML" != s.scrollParent[0].tagName ? ((!n.axis || "x" != n.axis) && (s.overflowOffset.top + s.scrollParent[0].offsetHeight - e.pageY < n.scrollSensitivity ? s.scrollParent[0].scrollTop = r = s.scrollParent[0].scrollTop + n.scrollSpeed : e.pageY - s.overflowOffset.top < n.scrollSensitivity && (s.scrollParent[0].scrollTop = r = s.scrollParent[0].scrollTop - n.scrollSpeed)),
            (!n.axis || "y" != n.axis) && (s.overflowOffset.left + s.scrollParent[0].offsetWidth - e.pageX < n.scrollSensitivity ? s.scrollParent[0].scrollLeft = r = s.scrollParent[0].scrollLeft + n.scrollSpeed : e.pageX - s.overflowOffset.left < n.scrollSensitivity && (s.scrollParent[0].scrollLeft = r = s.scrollParent[0].scrollLeft - n.scrollSpeed))) : ((!n.axis || "x" != n.axis) && (e.pageY - t(document).scrollTop() < n.scrollSensitivity ? r = t(document).scrollTop(t(document).scrollTop() - n.scrollSpeed) : t(window).height() - (e.pageY - t(document).scrollTop()) < n.scrollSensitivity && (r = t(document).scrollTop(t(document).scrollTop() + n.scrollSpeed))),
            ...
            !1 !== r && t.ui.ddmanager && !n.dropBehaviour && t.ui.ddmanager.prepareOffsets(s, e)
        }
    }),
        ...
        drag: function(e, i) {
            for (var s = t(this).data("draggable"), n = s.options, r = n.snapTolerance, o = i.offset.left, a = o + s.helperProportions.width, l = i.offset.top, h = l + s.helperProportions.height, c = s.snapElements.length - 1; c >= 0; c--) {
                ...
                if ("inner" != n.snapMode) {
                    ...
                    b && (i.position.left = s._convertPositionTo("relative", {
                        top: 0,
                        left: d
                    }).left - s.margins.left)
                }
        ...
        prepareOffsets: function(e, i) {
            ...
            g: for (var o = 0; o < s.length; o++)
                if (!s[o].options.disabled && (!e || s[o].accept.call(s[o].element[0], e.currentItem || e.element))) {
                    ...
                    s[o].visible && ("mousedown" == n && s[o]._activate.call(s[o], i),
        ...
        drag: function(e, i) {
            ...
            t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var s, n = t.ui.intersect(e, this, this.options.tolerance), r = n || 1 != this.isover ? n && 0 == this.isover ? "isover" : null : "isout";
                    if (r) {
                        if (this.options.greedy) {
                            var o = this.element.parents(":data(droppable):eq(0)");
                            o.length && ((s = t.data(o[0], "droppable")).greedyChild = "isover" == r ? 1 : 0)
                        }
                        s && "isover" == r && (s.isover = 0,
                        s.isout = 1,
                        s._out.call(s, i)),
                        this[r] = 1,
...
function(t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStart: function(e) {
            ...
            s.containment && (o += t(s.containment).scrollLeft() || 0,
            a += t(s.containment).scrollTop() || 0),
        ...
        _updateRatio: function(t, e) {
            ...
            "sw" == r && (t.left = i.left + (n.width - t.width),
            t.top = null),
            "nw" == r && (t.top = i.top + (n.height - t.height),
        ...
        _respectSize: function(t, e) {
            ...
            a && (t.width = i.minWidth),
            l && (t.height = i.minHeight),
            r && (t.width = i.maxWidth),
            o && (t.height = i.maxHeight);
            var h = this.originalPosition.left + this.originalSize.width
              , c = this.position.top + this.size.height
              , u = /sw|nw|w/.test(n)
              , d = /nw|ne|n/.test(n);
            a && u && (t.left = h - i.minWidth),
            r && u && (t.left = h - i.maxWidth),
            l && d && (t.top = c - i.minHeight),
            o && d && (t.top = c - i.maxHeight);
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        resize: function(e, i) {
            ...
            h[0] != document && /static/.test(h.css("position")) && (l = r),
            o.left < (s._helper ? r.left : 0) && (s.size.width = s.size.width + (s._helper ? s.position.left - r.left : s.position.left - l.left),
            a && (s.size.height = s.size.width / s.aspectRatio),
            s.position.left = n.helper ? r.left : 0),
            o.top < (s._helper ? r.top : 0) && (s.size.height = s.size.height + (s._helper ? s.position.top - r.top : s.position.top),
            a && (s.size.width = s.size.height * s.aspectRatio),
            s.position.top = s._helper ? r.top : 0),
            ...
            a && (s.size.height = s.size.width / s.aspectRatio)),
            u + s.size.height >= s.parentData.height && (s.size.height = s.parentData.height - u,
            a && (s.size.width = s.size.height * s.aspectRatio))
        },
        stop: function(e, i) {
            var s = t(this).data("resizable")
    ...
    t.ui.plugin.add("resizable", "grid", {
        resize: function(e, i) {
            ...
            /^(se|s|e)$/.test(l) ? (s.size.width = o.width + h,
            s.size.height = o.height + c) : /^(ne)$/.test(l) ? (s.size.width = o.width + h,
            s.size.height = o.height + c,
            s.position.top = a.top - c) : /^(sw)$/.test(l) ? (s.size.width = o.width + h,
            s.size.height = o.height + c,
            s.position.left = a.left - h) : (s.size.width = o.width + h,
            s.size.height = o.height + c,
            s.position.top = a.top - c,
            s.position.left = a.left - h)
        }
    });
    var i = function(t) {
            ...
            !this.options.disabled) {
                ...
                this.selectees.each(function() {
                    ...
                    if (l && l.element != i.element[0]) {
                        var h = !1;
                        "touch" == s.tolerance ? h = !(l.left > o || l.right < n || l.top > a || l.bottom < r) : "fit" == s.tolerance && (h = l.left > n && l.right < o && l.top > r && l.bottom < a),
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseCapture: function(e, i) {
            ...
            if (t(e.target).parents().each(function() {
                if (t.data(this, s.widgetName + "-item") == r)
                    return n = t(this),
                    !1
            }),
            t.data(e.target, s.widgetName + "-item") == r && (n = t(e.target)),
            !n)
                return !1;
        ...
        _mouseStart: function(e, i, s) {
            ...
            !s)
                for (var o = this.containers.length - 1; o >= 0; o--)
                    this.containers[o]._trigger("activate", e, r._uiHash(this));
        ...
        _mouseDrag: function(e) {
            ...
            for (var n = this.items.length - 1; n >= 0; n--) {
                ...
                if (a && o != this.currentItem[0] && this.placeholder[1 == a ? "next" : "prev"]()[0] != o && !t.ui.contains(this.placeholder[0], o) && ("semi-dynamic" != this.options.type || !t.ui.contains(this.element[0], o))) {
                    ...
                    "pointer" == this.options.tolerance || this._intersectsWithSides(r))
                        this._rearrange(e, r);
                    else
                        break;
                ...
                if (1 === this.containers.length)
                    ...
                    for (var r = 1e4, o = null, a = this.positionAbs[this.containers[s].floating ? "left" : "top"], l = this.items.length - 1; l >= 0; l--)
                        if (t.ui.contains(this.containers[s].element[0], this.items[l].item[0])) {
                            ...
                            Math.abs(h - a) < r && (r = Math.abs(h - a),
                            o = this.items[l],
                            this.direction = h - a > 0 ? "down" : "up")
                        }
                    if (!o && !this.options.dropOnEmpty)
                        return;
                    this.currentContainer = this.containers[s],
                    o ? this._rearrange(e, o, null, !0) : this._rearrange(e, null, this.containers[s].element, !0),
                    this._trigger("change", e, this._uiHash()),
...
jQuery.effects || function(t, e) {
    ...
    function r(e) {
        var i, s;
        for (i in e)
            (null == (s = e[i]) || t.isFunction(s) || i in u || /scrollbar/.test(i) || !/color/i.test(i) && isNaN(parseFloat(s))) && delete e[i];
        return e
    }
    function o(t, e) {
        var i, s = {
    ...
    t.effects.animateClass = function(e, i, s, a) {
        return t.isFunction(s) && (a = s,
        s = null),
        this.queue(function() {
            var l, h = t(this), u = h.attr("style") || " ", d = r(n.call(this)), p = h.attr("class") || "";
            ...
            h.animate(o(d, l), {
                ...
                complete: function() {
                    ...
                    h.attr("style").cssText = u) : h.attr("style", u),
    ...
    t.extend(t.easing, {
        ...
        easeInBack: function(t, i, s, n, r, o) {
            return o == e && (o = 1.70158),
            n * (i /= r) * i * ((o + 1) * i - o) + s
        },
        easeOutBack: function(t, i, s, n, r, o) {
            return o == e && (o = 1.70158),
            n * ((i = i / r - 1) * i * ((o + 1) * i + o) + 1) + s
        },
        easeInOutBack: function(t, i, s, n, r, o) {
            return o == e && (o = 1.70158),
            (i /= r / 2) < 1 ? n / 2 * i * i * (((o *= 1.525) + 1) * i - o) + s : n / 2 * ((i -= 2) * i * (((o *= 1.525) + 1) * i + o) + 2) + s
        },
...
function(t, e) {
    t.effects.blind = function(e) {
        return this.queue(function() {
            ...
            var h = {};
            h[a] = "show" == n ? l : 0,
            o.animate(h, e.duration, e.options.easing, function() {
                "hide" == n && i.hide(),
...
function(t, e) {
    t.effects.bounce = function(e) {
        return this.queue(function() {
            ...
            if ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -o : o),
            "hide" == n && (o /= 2 * a),
            "hide" != n && a--,
            "show" == n) {
                var u = {
                ...
                u[h] = ("pos" == c ? "+=" : "-=") + o,
                i.animate(u, l / 2, e.options.easing),
                o /= 2,
                a--
            }
            for (var d = 0; d < a; d++) {
                ...
                p[h] = ("pos" == c ? "-=" : "+=") + o,
                f[h] = ("pos" == c ? "+=" : "-=") + o,
                i.animate(p, l / 2, e.options.easing).animate(f, l / 2, e.options.easing),
                o = "hide" == n ? 2 * o : o / 2
            }
            if ("hide" == n) {
                var u = {
                ...
                u[h] = ("pos" == c ? "-=" : "+=") + o,
                i.animate(u, l / 2, e.options.easing, function() {
                    i.hide(),
                    t.effects.restore(i, s),
                    t.effects.removeWrapper(i),
                ...
                p[h] = ("pos" == c ? "-=" : "+=") + o,
                f[h] = ("pos" == c ? "+=" : "-=") + o,
                i.animate(p, l / 2, e.options.easing).animate(f, l / 2, e.options.easing, function() {
                    t.effects.restore(i, s),
                    t.effects.removeWrapper(i),
                    e.callback && e.callback.apply(this, arguments)
                })
...
function(t, e) {
    t.effects.clip = function(e) {
        return this.queue(function() {
            ...
            "show" == n && (a.css(l.size, 0),
            a.css(l.position, h / 2));
            var c = {};
            c[l.size] = "show" == n ? h : 0,
    ...
    t.effects.explode = function(e) {
        return this.queue(function() {
            ...
            var n = t(this).show().css("visibility", "hidden")
              , r = n.offset();
            r.top -= parseInt(n.css("marginTop"), 10) || 0,
            r.left -= parseInt(n.css("marginLeft"), 10) || 0;
    ...
    t.effects.fold = function(e) {
        return this.queue(function() {
            ...
            var l = t.effects.createWrapper(i).css({
              ...
              , d = /([0-9]+)%/.exec(r);
            d && (r = parseInt(d[1], 10) / 100 * u["hide" == n ? 0 : 1]),
            "show" == n && l.css(o ? {
                height: 0,
                width: r
            } : {
            ...
            p[c[0]] = "show" == n ? u[0] : r,
            f[c[1]] = "show" == n ? u[1] : 0,
            l.animate(p, a, e.options.easing).animate(f, a, e.options.easing, function() {
                "hide" == n && i.hide(),
                t.effects.restore(i, s),
                t.effects.removeWrapper(i),
                e.callback && e.callback.apply(i[0], arguments),
...
function(t, e) {
    ...
    t.effects.scale = function(e) {
        return this.queue(function() {
            var i = t(this)
              ...
              , a = e.options.origin;
            "effect" != n && (s.origin = a || ["middle", "center"],
            s.restore = !0);
            var l = {
                height: i.height(),
                width: i.width()
    ...
    t.effects.size = function(e) {
        return this.queue(function() {
            ...
            ("box" == u || "both" == u) && (g.from.y != g.to.y && (s = s.concat(a),
            i.from = t.effects.setTransition(i, a, g.from.y, i.from),
            i.to = t.effects.setTransition(i, a, g.to.y, i.to)),
            g.from.x != g.to.x && (s = s.concat(l),
            i.from = t.effects.setTransition(i, l, g.from.x, i.from),
            i.to = t.effects.setTransition(i, l, g.to.x, i.to))),
            ("content" == u || "both" == u) && g.from.y != g.to.y && (s = s.concat(o),
            i.from = t.effects.setTransition(i, o, g.from.y, i.from),
            i.to = t.effects.setTransition(i, o, g.to.y, i.to)),
            t.effects.save(i, c ? s : n),
            i.show(),
            t.effects.createWrapper(i),
            i.css("overflow", "hidden").css(i.from),
            ("content" == u || "both" == u) && (a = a.concat(["marginTop", "marginBottom"]).concat(o),
            l = l.concat(["marginLeft", "marginRight"]),
            r = s.concat(a).concat(l),
            i.find("*[width]").each(function() {
                ...
                g.from.y != g.to.y && (i.from = t.effects.setTransition(i, a, g.from.y, i.from),
                i.to = t.effects.setTransition(i, a, g.to.y, i.to)),
                g.from.x != g.to.x && (i.from = t.effects.setTransition(i, l, g.from.x, i.from),
                i.to = t.effects.setTransition(i, l, g.to.x, i.to)),
                i.css(i.from),
...
function(t, e) {
    t.effects.shake = function(e) {
        return this.queue(function() {
            ...
            u[l] = ("pos" == h ? "+=" : "-=") + 2 * r,
            d[l] = ("pos" == h ? "-=" : "+=") + 2 * r,
            i.animate(c, a, e.options.easing);
            for (var p = 1; p < o; p++)
                i.animate(u, a, e.options.easing).animate(d, a, e.options.easing);
    ...
    t.widget("ui.accordion", {
        ...
        _keydown: function(e) {
            if (!this.options.disabled && !e.altKey && !e.ctrlKey) {
                ...
                return !r || (t(e.target).attr("tabIndex", -1),
                t(r).attr("tabIndex", 0),
                r.focus(),
                !1)
            }
        ...
        _clickHandler: function(e, i) {
            ...
            if (!s.disabled) {
                ...
                var a = t(e.currentTarget || i)
                  , l = a[0] === this.active[0];
                if (s.active = (!s.collapsible || !l) && this.headers.index(a),
                !this.running && (s.collapsible || !l)) {
                    ...
                    l || (a.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").children(".ui-icon").removeClass(s.icons.header).addClass(s.icons.headerSelected),
        ...
        _toggle: function(e, i, s, n, r) {
            ...
            if (o._trigger("changestart", null, o.data),
            o.running = 0 === i.size() ? e.size() : i.size(),
            a.animated) {
                var h = {};
                h = a.collapsible && n ? {
                    toShow: t([]),
                ...
                a.animated = t.isFunction(a.proxied) ? a.proxied(h) : a.proxied,
                a.duration = t.isFunction(a.proxiedDuration) ? a.proxiedDuration(h) : a.proxiedDuration;
                ...
                a.collapsible && n ? e.toggle() : (i.hide(),
                e.show()),
                l(!0);
            i.prev().attr({
                "aria-expanded": "false",
    ...
    t.extend(t.ui.accordion, {
        ...
        animations: {
            slide: function(e, i) {
                ...
                var s, n = e.toShow.css("overflow"), r = 0, o = {}, a = {}, l = ["height", "paddingTop", "paddingBottom"], h = e.toShow;
                s = h[0].style.width,
                ...
                e.toHide.filter(":hidden").each(e.complete).end().filter(":visible").animate(a, {
                    step: function(t, i) {
                        "height" == i.prop && (r = i.end - i.start == 0 ? 0 : (i.now - i.start) / (i.end - i.start)),
                        e.toShow[0].style[i.prop] = r * o[i.prop].value + o[i.prop].unit
                    },
                    duration: e.duration,
                    easing: e.easing,
                    complete: function() {
...
function(t, e) {
    var i, s, n, r, o = "ui-button ui-widget ui-state-default ui-corner-all", a = "ui-state-hover ui-state-active ", l = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only", h = function() {
    ...
    t.widget("ui.button", {
        ...
        _create: function() {
            ...
            this.buttonElement.addClass(o).attr("role", "button").bind("mouseenter.button", function() {
                a.disabled || (t(this).addClass("ui-state-hover"),
        ...
        destroy: function() {
            ...
            this.buttonElement.removeClass(o + " " + a + " " + l).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()),
        ...
        _resetButton: function() {
            ...
            var e = this.buttonElement.removeClass(l)
              ...
              , r = [];
            s.primary || s.secondary ? (this.options.text && r.push("ui-button-text-icon" + (n ? "s" : s.primary ? "-primary" : "-secondary")),
            ...
            this.hasTitle || e.attr("title", i))) : r.push("ui-button-text-only"),
            e.addClass(r.join(" "))
        }
    }),
    ...
    $.extend(Datepicker.prototype, {
        ...
        _optionDatepicker: function(t, e, i) {
            ...
            s) {
                ...
                null !== o && undefined !== n.dateFormat && undefined === n.minDate && (s.settings.minDate = this._formatDate(s, o)),
                null !== a && undefined !== n.dateFormat && undefined === n.maxDate && (s.settings.maxDate = this._formatDate(s, a)),
        ...
        _showDatepicker: function(t) {
            ...
            !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                ...
                if (!1 !== s) {
                    ...
                    $.datepicker._updateDatepicker(e),
                    r = $.datepicker._checkOffset(e, r, n),
                    e.dpDiv.css({
                    ...
                    !e.inline) {
                        ...
                        $.effects && $.effects[o] ? e.dpDiv.show(o, $.datepicker._get(e, "showOptions"), a, l) : e.dpDiv[o || "show"](o ? a : null, l),
                        o && a || l(),
        ...
        _updateDatepicker: function(t) {
            ...
            r > 1 && t.dpDiv.addClass("ui-datepicker-multi-" + r).css("width", o * r + "em"),
        ...
        _checkOffset: function(t, e, i) {
            ...
            return e.left -= this._get(t, "isRTL") ? s - r : 0,
            e.left -= i && e.left == t.input.offset().left ? $(document).scrollLeft() : 0,
            e.top -= i && e.top == t.input.offset().top + o ? $(document).scrollTop() : 0,
            e.left -= Math.min(e.left, e.left + s > a && a > s ? Math.abs(e.left + s - a) : 0),
            e.top -= Math.min(e.top, e.top + n > l && l > n ? Math.abs(n + o) : 0),
            e
        },
        _findPos: function(t) {
        ...
        _selectDay: function(t, e, i, s) {
            ...
            if (!($(s).hasClass(this._unselectableClass) || this._isDisabledDatepicker(n[0]))) {
                ...
                r.selectedDay = r.currentDay = $("a", s).html(),
        ...
        _setDateFromField: function(t, e) {
            if (t.input.val() != t.lastVal) {
                var i, s, n = this._get(t, "dateFormat"), r = t.lastVal = t.input ? t.input.val() : null;
        ...
        _determineDate: function(t, e, i) {
            var s = function(t) {
              ...
              , n = function(e) {
                ...
                for (var s = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, n = s.getFullYear(), r = s.getMonth(), o = s.getDate(), a = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, l = a.exec(e); l; ) {
                    ...
                    case "M":
                        r += parseInt(l[1], 10),
                        o = Math.min(o, $.datepicker._getDaysInMonth(n, r));
                        break;
                    case "y":
                    case "Y":
                        n += parseInt(l[1], 10),
            ...
            return (r = r && "Invalid Date" == r.toString() ? i : r) && (r.setHours(0),
            r.setMinutes(0),
            r.setSeconds(0),
            r.setMilliseconds(0)),
        ...
        _generateHTML: function(t) {
            ...
            d) {
                ...
                for (g = u && g < u ? u : g; this._daylightSavingAdjust(new Date(f,p,1)) > g; )
                    --p < 0 && (p = 11,
                    f--)
            }
            t.drawMonth = p,
            ...
            this._get(t, "dayNamesMin")), P = this._get(t, "monthNames"), I = this._get(t, "monthNamesShort"), T = this._get(t, "beforeShowDay"), E = this._get(t, "showOtherMonths"), F = this._get(t, "selectOtherMonths"), z = (this._get(t, "calculateWeek") || this.iso8601Week,
            this._getDefaultDate(t)), M = "", O = 0; O < o[0]; O++) {
                var L = "";
                this.maxRows = 4;
                for (var N = 0; N < o[1]; N++) {
                    var H = this._daylightSavingAdjust(new Date(f,p,t.selectedDay))
                      ...
                      , R = "";
                    if (h) {
                        if (R += '<div class="ui-datepicker-group',
                        o[1] > 1)
                            switch (N) {
                            case 0:
                    ...
                    for (var X = this._daylightSavingAdjust(new Date(f,p,1 - V)), Q = 0; Q < U; Q++) {
                        ...
                        for (var Z = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(X) + "</td>" : "", j = 0; j < 7; j++) {
                            ...
                            Z += '<td class="' + ((j + k + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (X.getTime() == H.getTime() && p == t.selectedMonth && t._keyEvent || z.getTime() == X.getTime() && z.getTime() == H.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !E ? "" : " " + G[1] + (X.getTime() == c.getTime() ? " " + this._currentClass : "") + (X.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!J || E) && G[2] ? ' title="' + G[2] + '"' : "") + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + X.getMonth() + '" data-year="' + X.getFullYear() + '"') + ">" + (J && !E ? "&#xa0;" : tt ? '<span class="ui-state-default">' + X.getDate() + "</span>" : '<a class="ui-state-default' + (X.getTime() == e.getTime() ? " ui-state-highlight" : "") + (X.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + X.getDate() + "</a>") + "</td>",
                    ...
                    ++p > 11 && (p = 0,
                    f++),
                    R += "</tbody></table>" + (h ? "</div>" + (o[0] > 0 && N == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""),
                    L += R
                }
                M += L
            }
            return M += C + ($.browser.msie && 7 > parseInt($.browser.version, 10) && !t.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""),
            t._keyEvent = !1,
            M
        },
        _generateMonthYearHeader: function(t, e, i, s, n, r, o, a) {
            var l = this._get(t, "changeMonth")
              ...
              , d = "";
            if (r || !l)
                d += '<span class="ui-datepicker-month">' + o[e] + "</span>";
            else {
                var p = s && s.getFullYear() == i
                  , f = n && n.getFullYear() == i;
                d += '<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">';
                for (var g = 0; g < 12; g++)
                    (!p || g >= s.getMonth()) && (!f || g <= n.getMonth()) && (d += '<option value="' + g + '"' + (g == e ? ' selected="selected"' : "") + ">" + a[g] + "</option>");
                d += "</select>"
            }
            if (c || (u += d + (!r && l && h ? "" : "&#xa0;")),
            !t.yearshtml) {
                if (t.yearshtml = "",
                r || !h)
                    u += '<span class="ui-datepicker-year">' + i + "</span>";
                else {
                    var m = this._get(t, "yearRange").split(":")
                      ...
                      , $ = b(m[0])
                      , y = Math.max($, b(m[1] || ""));
                    for ($ = s ? Math.max($, s.getFullYear()) : $,
                    y = n ? Math.min(y, n.getFullYear()) : y,
                    t.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; $ <= y; $++)
                        t.yearshtml += '<option value="' + $ + '"' + ($ == i ? ' selected="selected"' : "") + ">" + $ + "</option>";
                    t.yearshtml += "</select>",
                    u += t.yearshtml,
                    t.yearshtml = null
                }
    ...
    t.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            var e = this
              ...
              , a = (e.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(o),
            (e.uiDialogTitlebar = t("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(o))
            ...
            t("<span></span>").addClass("ui-dialog-title").attr("id", r).html(n).prependTo(a),
        ...
        moveToTop: function(e, i) {
            var s, n = this, r = n.options;
            return (!r.modal || e) && (r.stack || r.modal) ? (r.zIndex > t.ui.dialog.maxZ && (t.ui.dialog.maxZ = r.zIndex),
        ...
        _makeDraggable: function() {
            ...
            var i, s = this, n = s.options, r = t(document);
            s.uiDialog.draggable({
                ...
                start: function(r, o) {
                    ...
                    s._trigger("dragStart", r, e(o))
                },
                drag: function(t, i) {
                    s._trigger("drag", t, e(i))
                },
                stop: function(o, a) {
                    n.position = [a.position.left - r.scrollLeft(), a.position.top - r.scrollTop()],
        ...
        _setOption: function(e, s) {
            ...
            case "draggable":
                ...
                o && !s && r.draggable("destroy"),
                !o && s && n._makeDraggable();
                break;
            case "position":
                n._position(s);
                break;
            case "resizable":
                ...
                a && !s && r.resizable("destroy"),
                a && "string" == typeof s && r.resizable("option", "handles", s),
                a || !1 === s || n._makeResizable(s);
                break;
            case "title":
        ...
        _size: function() {
            ...
            "auto" === s.height) {
                if (t.support.minHeight)
                    ...
                    this.element.height(Math.max(r, i))
                }
            } else
...
function(t, e) {
    ...
    t.fn.position = function(e) {
        ...
        e = t.extend({}, e);
        var a, l, h, c = t(e.of), u = c[0], d = (e.collision || "flip").split(" "), p = e.offset ? e.offset.split(" ") : [0, 0];
        return 9 === u.nodeType ? (a = c.width(),
        l = c.height(),
        h = {
            top: 0,
            left: 0
        }) : u.setTimeout ? (a = c.width(),
        l = c.height(),
        h = {
            top: c.scrollTop(),
            left: c.scrollLeft()
        }) : u.preventDefault ? (e.at = "left top",
        a = l = 0,
        h = {
            top: e.of.pageY,
            left: e.of.pageX
        ...
        "right" === e.at[0] ? h.left += a : e.at[0] === n && (h.left += a / 2),
        "bottom" === e.at[1] ? h.top += l : e.at[1] === n && (h.top += l / 2),
        h.left += p[0],
        h.top += p[1],
        this.each(function() {
            var i, s = t(this), o = s.outerWidth(), c = s.outerHeight(), u = parseInt(t.curCSS(this, "marginLeft", !0)) || 0, f = parseInt(t.curCSS(this, "marginTop", !0)) || 0, g = o + u + (parseInt(t.curCSS(this, "marginRight", !0)) || 0), m = c + f + (parseInt(t.curCSS(this, "marginBottom", !0)) || 0), v = t.extend({}, h);
            "right" === e.my[0] ? v.left -= o : e.my[0] === n && (v.left -= o / 2),
            "bottom" === e.my[1] ? v.top -= c : e.my[1] === n && (v.top -= c / 2),
            r.fractions || (v.left = Math.round(v.left),
    ...
    function() {
        var e, i, s, n, o, a = document.getElementsByTagName("body")[0], l = document.createElement("div");
        for (var h in e = document.createElement(a ? "div" : "body"),
        s = {
            visibility: "hidden",
            width: 0,
            height: 0,
        ...
        e.innerHTML = "",
        i.removeChild(e),
        o = n.top + n.left + (a ? 2e3 : 0),
        r.fractions = o > 21 && o < 22
    }()
}(jQuery),
function(t, e) {
...
function(t, e) {
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _create: function() {
            ...
            for (var l = n.length; l < o; l += 1)
                a.push(r);
            this.handles = n.add(t(a.join("")).appendTo(e.element)),
            ...
            this.handles.keydown(function(s) {
                ...
                if (!e.options.disabled) {
                    ...
                    switch (a = e.options.step,
                    r = o = e.options.values && e.options.values.length ? e.values(l) : e.value(),
                    s.keyCode) {
                    case t.ui.keyCode.HOME:
                        o = e._valueMin();
                        break;
        ...
        _mouseCapture: function(e) {
            ...
            !0 === u.range && this.values(1) === u.min && (a += 1,
            r = t(this.handles[a])),
            !1 !== (l = this._start(e, a)) && (this._mouseSliding = !0,
            o._handleIndex = a,
        ...
        _slide: function(t, e, i) {
            ...
            s = this.values(e ? 0 : 1),
            !1 !== r && this.values(e, i, !0))) : i !== this.value() && !1 !== (r = this._trigger("slide", t, {
                handle: this.handles[e],
                value: i
            })) && this.value(i)
        },
        ...
        _refreshValue: function() {
            var e, i, s, n, r, o = this.options.range, a = this.options, l = this, h = !this._animateOff && a.animate, c = {};
            ...
            n = this._valueMin(),
            e = (r = this._valueMax()) !== n ? (s - n) / (r - n) * 100 : 0,
            c["horizontal" === l.orientation ? "left" : "bottom"] = e + "%",
...
function(t, e) {
    ...
    t.widget("ui.tabs", {
        ...
        _tabify: function(i) {
            ...
            var n, r, o = this, a = this.options, l = /^#.+/;
            ...
            this.anchors.each(function(e, i) {
                var s, n = t(i).attr("href"), r = n.split("#")[0];
                if (r && (r === location.toString().split("#")[0] || (s = t("base")[0]) && r === s.href) && (n = i.hash,
                i.href = n),
                l.test(n))
                    o.panels = o.panels.add(o.element.find(o._sanitizeSelector(n)));
                else if (n && "#" !== n) {
                    ...
                    c.length || (c = t(a.panelTemplate).attr("id", h).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(o.panels[e - 1] || o.list)).data("destroy.tabs", !0),
                    o.panels = o.panels.add(c)
                } else
                    a.disabled.push(e)
            }),
            ...
            a.selected === e ? (location.hash && this.anchors.each(function(t, e) {
                if (e.hash == location.hash)
                    return a.selected = t,
                    !1
            }),
            "number" != typeof a.selected && a.cookie && (a.selected = parseInt(o._cookie(), 10)),
            "number" != typeof a.selected && this.lis.filter(".ui-tabs-selected").length && (a.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))),
            a.selected = a.selected || (this.lis.length ? 0 : -1)) : null === a.selected && (a.selected = -1),
            a.selected = a.selected >= 0 && this.anchors[a.selected] || a.selected < 0 ? a.selected : 0,
            a.disabled = t.unique(a.disabled.concat(t.map(this.lis.filter(".ui-state-disabled"), function(t, e) {
                return o.lis.index(t)
            }))).sort(),
            -1 != t.inArray(a.selected, a.disabled) && a.disabled.splice(t.inArray(a.selected, a.disabled), 1),
            this.panels.addClass("ui-tabs-hide"),
            this.lis.removeClass("ui-tabs-selected ui-state-active"),
            a.selected >= 0 && this.anchors.length && (o.element.find(o._sanitizeSelector(o.anchors[a.selected].hash)).removeClass("ui-tabs-hide"),
            this.lis.eq(a.selected).addClass("ui-tabs-selected ui-state-active"),
            ...
            this.load(a.selected)),
            t(window).bind("unload", function() {
                o.lis.add(o.anchors).unbind(".tabs"),
                o.lis = o.anchors = o.panels = null
            })) : a.selected = this.lis.index(this.lis.filter(".ui-tabs-selected")),
            this.element[a.collapsible ? "addClass" : "removeClass"]("ui-tabs-collapsible"),
            a.cookie && this._cookie(a.selected, a.cookie);
            for (var h, c = 0; h = this.lis[c]; c++)
                t(h)[-1 == t.inArray(c, a.disabled) || t(h).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
            if (!1 === a.cache && this.anchors.removeData("cache.tabs"),
            ...
            var p = r ? function(e, i) {
                ...
                i.hide().removeClass("ui-tabs-hide").animate(r, r.duration || "normal", function() {
                    s(i, r),
                    o._trigger("show", null, o._ui(e, i[0]))
                })
            }
            : function(e, i) {
                t(e).closest("li").addClass("ui-tabs-selected ui-state-active"),
              ...
              , f = n ? function(t, e) {
                e.animate(n, n.duration || "normal", function() {
                    o.lis.removeClass("ui-tabs-selected ui-state-active"),
            ...
            this.anchors.bind(a.event + ".tabs", function() {
                ...
                if (i.hasClass("ui-tabs-selected") && !a.collapsible || i.hasClass("ui-state-disabled") || i.hasClass("ui-state-processing") || o.panels.filter(":animated").length || !1 === o._trigger("select", null, o._ui(this, n[0])))
                    return this.blur(),
                    !1;
                if (a.selected = o.anchors.index(this),
                o.abort(),
                a.collapsible) {
                    if (i.hasClass("ui-tabs-selected"))
                        return a.selected = -1,
                        a.cookie && o._cookie(a.selected, a.cookie),
                        o.element.queue("tabs", function() {
                            f(e, s)
                        }).dequeue("tabs"),
                        this.blur(),
                        !1;
                    if (!s.length)
                        return a.cookie && o._cookie(a.selected, a.cookie),
                        o.element.queue("tabs", function() {
                            p(e, n)
                        }),
                ...
                if (a.cookie && o._cookie(a.selected, a.cookie),
                n.length)
        ...
        add: function(i, s, n) {
            ...
            return h.length || (h = t(o.panelTemplate).attr("id", l).data("destroy.tabs", !0)),
            h.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"),
            n >= this.lis.length ? (a.appendTo(this.list),
            h.appendTo(this.list[0].parentNode)) : (a.insertBefore(this.lis[n]),
            h.insertBefore(this.panels[n])),
            o.disabled = t.map(o.disabled, function(t, e) {
                return t >= n ? ++t : t
            }),
            this._tabify(),
            1 == this.anchors.length && (o.selected = 0,
        ...
        load: function(e) {
            ...
            if (this.abort(),
            !r || 0 !== this.element.queue("tabs").length && t.data(n, "cache.tabs")) {
            ...
            return this.xhr = t.ajax(t.extend({}, s.ajaxOptions, {
                ...
                success: function(r, o) {
                    i.element.find(i._sanitizeSelector(n.hash)).html(r),
                    i._cleanup(),
    ...
    t.extend(t.ui.tabs.prototype, {
        ...
        rotate: function(t, e) {
            ...
            this.anchors.bind(s.event + ".tabs", r),
            n()) : (clearTimeout(i.rotation),
            this.element.unbind("tabsshow", n),
            this.anchors.unbind(s.event + ".tabs", r),
            delete this._rotate,
...
function(t, e) {
    ...
    t.widget("kf." + c, {
        ...
        _create: function() {
            var e, r, h = this, d = h.options, p = h.element, f = p.find(d.steps).eq(0).parent();
            p[0].elements ? e = p : (e = p.find(l)).length || (e = p.closest(l)),
            (r = p.find(d.header)).length || (r = e.find(d.header)),
            h.elements = {
        ...
        _find: function(e, i, s) {
            ...
            if (null !== e && u.length)
                for (r = 0,
                a = (e = o(e)).length; r < a; r++)
                    n = null,
                    (h = typeof (l = e[r])) === d ? n = u.get(l) : h === f ? n = document.getElementById(l.replace("#", "")) : h === p && (l instanceof jQuery && l.length && (l = l[0]),
                    l.nodeType && u.each(g)),
                    n && c.push(n);
            return !1 === s ? c : t(c)
        },
        _move: function(i, s, n, r, o) {
            ...
            n = s,
            s = e),
            !0 === n ? i > 0 ? a._fastForward(i, n, h) : o.call(a, l.stepsActivated[Math.max(0, i + (l.stepsActivated.length - 1))]) : -1 !== (i = a.stepIndex(i, s)) && (i > l.stepIndex ? a._fastForward(i, h) : h.call(a, i))
        },
        _state: function(e, i) {
            ...
            for (var r, a, l, h = 0, c = i.length; h < c; h++)
                e = i[h],
                r = this._branchLabels[e],
                !n.stepIndex || n.stepIndex < e ? 0 > t.inArray(e, n.stepsActivated) && (n.stepsActivated.push(e),
                0 > t.inArray(r, n.branchesActivated) && n.branchesActivated.push(r)) : n.stepIndex > e && (a = t.inArray(r, n.branchesActivated) + 1,
                l = t.inArray(e, n.stepsActivated) + 1,
                a > 0 && n.branchesActivated.splice(a, n.branchesActivated.length - 1),
        ...
        _transition: function(i, s, n) {
            var a = this;
            t.isFunction(i) ? (n = i,
            i = a._currentState.stepIndex,
            s = e) : t.isFunction(s) && (n = s,
            s = e);
            var l, h = a.options, c = a.step(i, s), d = c.attr(h.stateAttribute), p = d ? h.transitions[d] : h.transitions[u];
        ...
        _update: function(e, i) {
            var s = this._currentState
              , n = this.options;
            if (s.step) {
                if (n.disabled || !i || i.stepIndex === s.stepIndex || !this._trigger(x, e, i) || i.isMovingForward && !this._trigger(_, e, i) || !i.isMovingForward && !this._trigger(y, e, i))
                    return;
            ...
            s.step && (this._trigger($, e, i),
            this._trigger(i.isMovingForward ? b : m, e, i))
        },
        backward: function(t, i) {
            typeof t === d && (i = t,
            t = e),
            i === e && (i = 1),
            !this._currentState.isFirstStep && typeof i === d && this._move(-i, !0, !1, function(e, i) {
        ...
        forward: function(t, i, s) {
            ...
            t = e),
            i === e && (i = 1),
            !this._currentState.isLastStep && typeof i === d && this._move(i, !0, s, function(e, i) {
                this._update(t, this._state(e, i))
            })
        },
        ...
        select: function(i, s, n, r, o) {
            ...
            r = n,
            n = s[1],
            s = s[0]) : typeof n === g ? (o = r,
            r = n,
            n = e) : t.isArray(n) && (o = n,
            n = e),
            this._move(s, n, r, o, function(t, e) {
        ...
        step: function(i, s) {
            ...
            i = i[0]),
            typeof i === d ? r = this._find(i, s !== e ? this.steps(s) : this.elements.steps) : (r = this._find(i, this.elements.steps.add(this.elements.branches))) && r.hasClass(n.branch) && (r = this._find(s || 0, this.steps(r))),
            r) : this._currentState.step
        },
        stepIndex: function(i, n, r) {
            var o;
            return arguments.length ? (t.isArray(i) ? (r = n,
            n = i[1],
            i = i[0]) : typeof n === g && (r = n,
            n = e),
            (o = this.step(i, n)) ? (r ? o.siblings(s.step).andSelf() : this.elements.steps).index(o) : -1) : this._currentState.stepIndex
        },
        steps: function(t) {
...
function(t) {
    ...
    t.extend(t.validator, {
        ...
        prototype: {
            ...
            check: function(e) {
                e = this.validationTargetFor(this.clean(e));
                var i, s = t(e).rules(), n = !1, r = this.elementValue(e);
                for (var o in s) {
                    var a = {
                        method: o,
                        parameters: s[o]
                    ...
                    try {
                        if (i = t.validator.methods[o].call(this, r, e, a.parameters),
        ...
        attributeRules: function(e) {
            var i, s = {}, n = t(e), r = n[0].getAttribute("type");
            for (var o in t.validator.methods)
                "required" === o ? ("" === (i = n.get(0).getAttribute(o)) && (i = !0),
                i = !!i) : i = n.attr(o),
                /min|max/.test(o) && (null === r || /number|range|text/.test(r)) && (i = Number(i)),
                i ? s[o] = i : r === o && "range" !== r && (s[o] = !0);
        ...
        dataRules: function(e) {
            ...
            for (i in t.validator.methods)
                void 0 !== (s = r.data("rule-" + i.toLowerCase())) && (n[i] = s);
            return n
        },
...
function(t) {
    ...
    if (t.ajaxPrefilter)
        ...
        t.ajax = function(s) {
            ...
            return "abort" === n ? (e[r] && e[r].abort(),
            e[r] = i.apply(this, arguments),
            e[r]) : i.apply(this, arguments)
        }
    }
}(jQuery),
...
function(t, e, i) {
    ...
    s.prototype = {
        ...
        init_: function() {
            var t = this;
            t.initEvents_(),
            t.loop_(function(e, i) {
                var s = t.config_[i].style;
                e.addEventListener("reset", t.events.reset),
                e.classList.add(t.prefixed_("form")),
                s && e.classList.add(t.prefixed_("style-" + s))
            }, function(e) {
                t.floatLabel_(e)
            })
        },
        ...
        build_: function(t) {
            var e = this
              , i = e.getLabel_(t);
            i && (t.classList.add(e.prefixed_(t.tagName.toLowerCase())),
            e.setLabel_(i, t),
        ...
        createEl_: function(t, i) {
            ...
            for (var n in i = i || {})
                i.hasOwnProperty(n) && s.setAttribute(n, i[n]);
            return s
        },
        extend_: function() {
            ...
            return Object.keys(i).forEach(function(t) {
                for (var s in i[t])
                    i[t].hasOwnProperty(s) && (e[s] = i[t][s])
            }),
            e
        },
        ...
        getLabel_: function(t) {
            ...
            return i.length > 1 && (i = t.parentNode.querySelectorAll(e)),
            1 === i.length && i[0]
        },
        getLabelText_: function(t, e) {
            var i = t.textContent.replace("*", "").trim()
              , s = e.getAttribute("placeholder");
            return (!i || i && s && "placeholder" === this.config_[this.current_].prioritize) && (i = s),
            i
        },
        handleEvents_: function(t, e) {
            var i = this.events;
            ["blur", "input", "focus"].forEach(function(s) {
                "input" === s && ("file" === t.type || "SELECT" === t.nodeName) && (s = "change"),
                t[e + "EventListener"](s, i[s])
            })
        },
        ...
        loop_: function(t, e) {
            for (var i = this, s = 0; s < i.el_.length; ++s) {
                if (void 0 === i.selectors_[s]) {
                    ...
                    i.selectors_[s] = n.transform.replace(/,/g, r + ",") + r,
                    i.config_[s] = n
                }
                var o = i.el_[s].querySelectorAll(i.selectors_[s]);
                i.current_ = s,
                "function" == typeof t && t.call(i, i.el_[s], s);
                for (var a = 0; a < o.length; ++a)
                    "function" == typeof e && e.call(i, o[a], s)
            }
        },
        onBlur_: function(t) {
        ...
        reset_: function(t) {
            ...
            if (i.hasParent_(t)) {
                ...
                i.resetPlaceholder_(t),
                i.handleEvents_(t, "remove")
            }
        },
        resetFields_: function() {
            for (var t = this, e = t.el_[t.current_].querySelectorAll(t.selectors_[t.current_]), i = 0; i < e.length; ++i)
                e[i].parentNode.classList[t.addRemove_("SELECT" === e[i].tagName && "" !== e[i].value)](t.prefixed_("is-active"))
        },
        resetPlaceholder_: function(t) {
            var e = "data-placeholder"
              , i = t.getAttribute(e);
            null !== i && (t.removeAttribute(e),
            t.setAttribute("placeholder", i))
        },
        setLabel_: function(t, e) {
            var i = this;
            t.classList.add(i.prefixed_("label")),
            t.textContent = i.getLabelText_(t, e),
            "function" == typeof i.config_[i.current_].customLabel && (t.textContent = i.config_[i.current_].customLabel.call(i, t, e))
        },
        setPlaceholder_: function(t, e) {
            var i = this
              , s = e.getAttribute("placeholder");
            "label" !== i.config_[i.current_].prioritize && s || (s && e.setAttribute("data-placeholder", s),
            s = i.getLabelText_(t, e)),
            "function" == typeof i.config_[i.current_].customPlaceholder && (s = i.config_[i.current_].customPlaceholder.call(i, s, e, t)),
            "SELECT" === e.tagName ? i.setSelectPlaceholder_(e, s) : e.setAttribute("placeholder", s)
        },
        setSelectPlaceholder_: function(t, e) {
            var i = t.firstElementChild;
            i.hasAttribute("value") && i.value ? (t.insertBefore(new Option(e,""), i),
            !1 === t.options[t.selectedIndex].defaultSelected && (t.selectedIndex = 0)) : i.setAttribute("value", ""),
        ...
        wrapLabel_: function(t, e) {
            ...
            void 0 !== e.value && e.value.length && s.classList.add(i.prefixed_("is-active")),
            (null !== e.getAttribute("required") || e.classList.contains(i.config_[i.current_].requiredClass)) && s.classList.add(i.prefixed_("is-required")),
